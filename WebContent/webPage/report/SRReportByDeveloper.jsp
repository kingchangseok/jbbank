...
<div class="contentFrame">
	<div id="history_wrap">보고서 <strong>&gt; 개발담당자별 SR현황</strong></div>
		<div class="az_search_wrap" style="min-width: 1160px;">
			<div class="az_in_wrap">
				<div class="row">
					<div class="dib vat margin-20-right margin-10-left">
	                	<label class="tit_70 por">개발담당자</label>
	                	<div class="margin-10-left vat dib">
		                	<input id="developerTxt" type="text" class="width-100">
	                	</div>
	                </div>
...
<script type="text/javascript" src="<c:url value="/js/ecams/report/SRReportByDeveloper.js"/>"></script>