...
<%
    ...
    ecamsLogger.error("Request_CodeList.jsp Start");
    ...
    ecamsLogger.error("Request_CodeList.jsp ["+inData+"]");
    if (!"ER".equals(inData.substring(0,2))) {
    	retMsg = srrestapi.getCodeInfo(inData);
    } else {
    	retMsg = srrestapi.setError(retMsg);
    }
    srrestapi = null;
    
    ecamsLogger.error("Request_CodeList.jsp Return="+retMsg);
    ecamsLogger = null;
