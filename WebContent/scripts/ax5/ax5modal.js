...
(function () {
  ...
  UI.addClass({
    ...
    return function () {
      ...
      // modal에서 modal 띄울 때 겹치는 증상 수정
      if(window.parent != null && window.parent.ax5 != null && window.parent.ax5 != undefined) {
    	  this.instanceId = window.parent.ax5.guid+1 + "_" + ax5.getGuid();
      } else {
