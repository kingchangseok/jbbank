...
<div id="wrapper">
    <div class="contentFrame">
        <div id="history_wrap">보고서 <strong>&gt; 대결처리내역</strong></div>
	    ...
	    <div class="az_board_basic">
	    	<div id="approvalGrid" data-ax5grid="approvalGrid" data-ax5grid-config="{}" style="width:100%; height: 100%;" class="resize">
			</div>
		</div>
...
<script type="text/javascript" src="<c:url value="/js/ecams/report/ApprovalReport.js"/>"></script>