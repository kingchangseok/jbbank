...
<div id="srTab" class="half_wrap" style="height:54%; margin-top:10px;">
	<div class="tab_wrap">
		<ul class="tabs">
			...
			<li rel="tabTargetProgram" id="tab4">대상프로그램</li>
			<li rel="tabTargetOutput" id="tab5">대상산출물</li>
			<li rel="tabUnitTest" id="tab3" class="on">단위테스트</li>
			<div class="r_wrap">
...
<script type="text/javascript"
	src="<c:url value="/js/ecams/rfc/UnitTest.js"/>"></script>
