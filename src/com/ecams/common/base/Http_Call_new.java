...
public class Http_Call_new {
	...
	public static byte[] httpProcess(HashMap<String, String> etcData) throws Exception {
		HttpURLConnection htpConn = null;
		byte[] byteData = null;
		String retMsg = "OK";
		
		try {
			ecamsLogger.error("## HttpCall_New.httpProcess() " + etcData.get("remoteURL") + "  " + etcData.get("reqMethod") + "  " + etcData.get("sendData"));
			...
			ecamsLogger.error("## HttpCall_New.httpProcess() " + "return=["+retMsg+"]");
			System.out.println("return=["+retMsg+"]");
			if ("OK".equals(retMsg)) {
			...
			exception.getStackTrace();
			System.out.println("## HttpCall.httpProcess() Exception START ##");
			System.out.println("## Error DESC : " + exception);
			System.out.println("## HttpCall.httpProcess() Exception END ##");
			retMsg = "ER:처리 중 오류발생";
			byteData = retMsg.getBytes();
		} catch (Exception exception) {
			exception.getStackTrace();
	...
	private static HttpURLConnection httpOpen(String pURL, String pMethod) throws Exception
	{
		HttpURLConnection htpConn = null;
		...
		try	{
			...
			exception.getStackTrace();
			System.out.println("## HttpCall.httpOpen() Exception START ##");
			System.out.println("## Error DESC : " + exception);
			System.out.println("## HttpCall.httpOpen() Exception END ##");
	...
	private static String httpSend(HttpURLConnection phtpConn, byte[] pbyteData) throws Exception
	{
		try {
			...
			exception.getStackTrace();
			System.out.println("## HttpCall.httpSend() Exception START ##");
			System.out.println("## Error DESC : " + exception);
			System.out.println("## HttpCall.httpSend() Exception END ##");
			return "ER";
	...
	public static byte[] httpReceive(HttpURLConnection phtpConn,String savePath) throws Exception
	{
		String errMsg = "";
		try {
			...
			exception.getStackTrace();
			System.out.println("## HttpCall.httpReceive() Exception START ##");
			System.out.println("## Error DESC : "+ exception);
			System.out.println("## HttpCall.httpReceive() Exception END ##");
	...
	public byte[] process(String psSvrURL, String psAct, byte[] pbyteData) throws Exception
	{
		...
		{
			exception.getStackTrace();
			System.out.println("## HttpCom.process() Exception START ##");
			System.out.println("## Error DESC : "+ exception);
			System.out.println("## HttpCom.process() Exception END ##");
			throw new Exception(exception.getMessage());
		}
		catch (Exception exception)
		{
	...
	private static void close(HttpURLConnection phtpConn)
	{
	...
	private int send(HttpURLConnection phtpConn, byte[] pbyteData) throws Exception
	{
		try {
			...
			exception.getStackTrace();
			System.out.println("## HttpCom.send() Exception START ##");
			System.out.println("## Error DESC : "+ exception);
			System.out.println("## HttpCom.send() Exception END ##");
			return 1;
		} catch (Exception exception)	{
			exception.getStackTrace();
			System.out.println("## HttpCom.send() Exception START ##");
	...
	public byte[] receive(HttpURLConnection phtpConn) throws Exception
	{
		...
		try {
			...
			exception.getStackTrace();
			System.out.println("## HttpCom.receive() Exception START ##");
			System.out.println("## Error DESC : " + exception);
			System.out.println("## HttpCom.receive() Exception END ##");
	...
	public Map<String,Map<String,String>> strToMap (String recvStr) throws Exception
	{
		...
		try {
			for (int i=0;strList1.length>i;i++) {
				...
				System.out.println("++ strList1 1 ++"+strWork);
				...
				System.out.println("++ strList1 2 ++"+strKey + ", "+strWork);
				strList2 = strWork.split(",");
				rst = new HashMap<String,String>();
				for (j=0;strList2.length>j;j++) {
					strWork = strList2[j].trim();
					System.out.println("++ strList2 3 ++"+strWork);
			...
			exception.getStackTrace();
			System.out.println("## HttpCom.strToMap() Exception START ##");
			System.out.println("## Error DESC : " + exception);
			System.out.println("## HttpCom.strToMap() Exception END ##");
			throw new Exception(exception.getMessage());
