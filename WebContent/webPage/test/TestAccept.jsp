...
<div id="history_wrap">테스트관리 <strong>&gt; 테스트접수</strong></div>
...
<div id="test_tab" class="half_wrap" style="height:50%; margin-top:10px;">
	<div class="tab_wrap">
		<ul class="tab">
			<li rel="tabTestAccept" id="testTab" class="on">테스트접수</li>
			<div class="r_wrap">
...
<script type="text/javascript" src="<c:url value="/js/ecams/test/TestAccept.js"/>"></script>
