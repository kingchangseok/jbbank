                ...
                <div class="vat width-100">
                    ...
                    <div class="ml_100">
                        <div class="width-100">
                            ...
                            <button id="btnReq" name="btnReq" class="btn_basic_s" style="margin-left:10px;visibility: hidden;">대상프로그램추가</button>                          
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<c:url value="/js/ecams/tab/rfc/TargetProgramTab.js"/>"></script>
