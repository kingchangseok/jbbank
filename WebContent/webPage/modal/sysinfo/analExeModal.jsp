	...
	<div class="container-fluid pop_wrap">
		...
		<div>					
			<div class="width-100 dib vat">
	            <label id="lbUser" class="title">영향분석대상확장자리스트</label>
			</div>
			<div class="row">
...
<script type="text/javascript" src="<c:url value="/js/ecams/modal/sysinfo/analExeModal.js"/>"></script>