...
<%
    ...
    ecamsLogger.error("Request_CC_PRD_Updt.jsp Start");
    ...
    ecamsLogger.error("Request_CC_PRD_Updt.jsp ["+inData+"]");
    if (!"ER".equals(inData.substring(0,2))) {
    	retMsg = srrestapi.setSRUpdt_PRD(inData);
    } else {
    	retMsg = srrestapi.setError(retMsg);
    }
    srrestapi = null;
    
    ecamsLogger.error("Request_CC_PRD_Updt.jsp Return="+retMsg);
    ecamsLogger = null;
