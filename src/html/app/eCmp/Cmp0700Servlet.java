...
import app.eCmp.Cmp0700;

@WebServlet("/webPage/ecmp/Cmp0700Servlet")
public class Cmp0700Servlet extends HttpServlet {
	...
	*/ 
	private String getReqList(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmp0700.getReqList(UserId,sDate,eDate));
		} catch (IOException e) {
