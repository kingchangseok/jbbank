...
<div class="container-fluid pop_wrap">
	<div id="divSayu">
		<label class="tit_60 poa">상세내역</label>
		<div class="ml_60 vat">
			<textarea id="txtSayu" class="dib" style="width:100%;height:50px;border:1px solid #ccc;resize: none;padding:5px;"></textarea>
		</div>
	</div>
	<!--line1-->
	<div class="az_board_basic az_board_basic_in" style="height:calc(78% - 55px); margin-top: 5px;">
	...
	<div class="row tac">
		...
		<div class="float-right">
			...
			<button class="btn_basic" id="btnFileDelete">삭제</button>
			<button class="btn_basic" id="btnReq">선택완료</button>
		</div>
...
<script type="text/javascript" src="<c:url value="/js/ecams/modal/fileupload/FileUpload2.js"/>"></script>