...
@WebServlet("/webPage/ecmm/Cmm2100Servlet")
public class Cmm2100Servlet extends HttpServlet {
	...
	*/ 
	private String get_sql_Qry(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmm2100.get_sql_Qry(Cbo_Find,Txt_Find,strStD,strEdD));
		} catch (IOException e) {
	...
	*/ 
	private String getFileList(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmm2100.getFileList(AcptNo));
		} catch (IOException e) {
		    return ParsingCommon.toJson("ERROR"+e.getMessage());
		} catch (Exception e) {
			return ParsingCommon.toJson("ERROR"+e.getMessage());
