...
<div class="contentFrame">
	...
	<!-- 하단 S-->
	<div class="half_wrap margin-10-top" style="height: 73%">
		<!-- tab S-->
		<div class="tab_wrap">
			<ul class="tabs">
				...
				<li rel="tabDevCheck" id="tab5" class="on">개발검수</li>
			</ul>
		</div>
		<!-- tab E-->
...
<script type="text/javascript" src="<c:url value="/js/ecams/sr/DevCheck.js"/>"></script>