...
public class Cmp3500{   
	...
	public Object[] getProgList(String UserId,String Gubun,String StDate,String EdDate,String Step1,String Step2,String Step3,String Step4,String SysCd,String JobCd) throws SQLException, Exception {
		...
		try {
			...
			strQuery.append("  decode(b.cr_rsrccd,'46','12','47','12','48','12','49','12','50','12',b.cr_rsrccd),count(*) as cnt \n");
			...
			strQuery.append("decode(b.cr_rsrccd,'46','12','47','12','48','12','49','12','50','12',b.cr_rsrccd) \n");
			...
			while (rs.next()){
				...
				strRsrc = rs.getString("decode(b.cr_rsrccd,'46','12','47','12','48','12','49','12','50','12',b.cr_rsrccd)");
