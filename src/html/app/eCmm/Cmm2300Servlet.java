...
import app.eCmm.Cmm2300;

@WebServlet("/webPage/ecmm/Cmm2300Servlet")
public class Cmm2300Servlet extends HttpServlet {
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	/* Parameter 
	* String Cbo_Find,String Txt_Find,String strStD,String strEdD
	*/ 
	private String get_sql_Qry(JsonElement jsonElement) throws SQLException, Exception {
		Cmm2300 cmm2300 = new Cmm2300();
		try {
		    ...
		    return ParsingCommon.toJson(cmm2300.get_sql_Qry(Cbo_Find,Txt_Find,strStD,strEdD));
		} catch (IOException e) {
	...
	*/ 
	private String getFileList(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmm2300.getFileList(AcptNo));
		} catch (IOException e) {
		    return ParsingCommon.toJson("ERROR"+e.getMessage());
		} catch (Exception e) {
			return ParsingCommon.toJson("ERROR"+e.getMessage());
