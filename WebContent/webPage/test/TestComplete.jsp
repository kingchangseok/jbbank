...
<div class="az_search_wrap" style="height:30%">
	<div class="az_in_wrap sr_status" style="height:100%">
		...
		<div class="row por" style="height: 79%;">
...
<div id="test_tab" class="half_wrap" style="height:52%; margin-top:10px;">
	<div class="tab_wrap">
		<ul class="tabs">
...
<script type="text/javascript" src="<c:url value="/js/ecams/test/TestComplete.js"/>"></script>
