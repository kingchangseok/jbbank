...
<body style="padding: 10px !important; width: 100% !important; min-width: 0px !important;">
	...
	<div class="l_wrap width-100 vat write_wrap"><!--ver2-->
		...
		<div class="row">
			<dl>
				<dt><label>작업내용</label></dt>
				<dd style="font-size: 0px;">
					<div style="width:calc(70% - 10px); margin-right: 10px;" class="dib vat ">
					...
					<div style="width:30%;" class="dib vat">
						<div class="row">
							<button id="cmdDoc" class="btn_basic_s margin-5-right" disabled=true>파일첨부</button>
							<label style="color: blue; font-size: 12px;">첨부파일은 20MB이하만 가능</label>
						</div>
						<div class="row">
							<div data-ax5grid="grdDoc" data-ax5grid-config="{showLineNumber: true, lineNumberColumnWidth: 40}" style="height: 230px;"></div>
						</div>
					</div>
				</dd>
			</dl>
		...
		<div class="row float-right">
			<button id="cmdCncl" class="btn_basic_s" disabled=true>취소</button>
			<button id="cmdReq" class="btn_basic_s" disabled=true>등록</button>
		</div>
	</div>
	<div id="fileSave" style="display: none;">
	</div>
</body>
...
<script type="text/javascript" src="<c:url value="/js/ecams/tab/sr/WorkRegisterTab.js"/>"></script>