...
$(document).ready(function() {
	...
	$('#tabIntegrationTest').show();
	
	clickTabMenu();
	
	document.getElementById('frmIntegrationTest').onload = function() {
		getTeamInfoGrid2();		
	}
});
...
function iSRID_Click(data) {
	...
	//그리드 row 선택시 단위테스트 탭으로 변경
	if(!$("ul.tabs li#tab4").hasClass("on")) {
		$(".tab_content").hide();
		var activeTab = $("ul.tabs li#tab4").attr("rel");
		
		//tab메뉴 클릭에 따라 색상 변경
		$("ul.tabs li").removeClass('on');
		$("ul.tabs li#tab4").addClass("on");
