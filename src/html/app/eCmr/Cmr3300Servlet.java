...
import app.eCmr.Cmr3300;

@WebServlet("/webPage/ecmr/Cmr3300Servlet")
public class Cmr3300Servlet extends HttpServlet {
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	/* Parameter 
	* String pSysCd,String pStartDt,String pEndDt,String pDept,String pTeam,String pUserId,String Radio_Result,String ChkRes
	*/ 
	private String get_SelectList(JsonElement jsonElement) throws SQLException, Exception {
		Cmr3300 cmr3300 = new Cmr3300();
		try {
		    ...
		    String pDept = ParsingCommon.jsonStrToStr(ParsingCommon.jsonEtoStr(jsonElement, "pDept"));
		    ...
		    String Radio_Result = ParsingCommon.jsonStrToStr(ParsingCommon.jsonEtoStr(jsonElement, "Radio_Result"));
		    String ChkRes = ParsingCommon.jsonStrToStr(ParsingCommon.jsonEtoStr(jsonElement, "ChkRes"));
		    return ParsingCommon.toJson(cmr3300.get_SelectList(pSysCd,pStartDt,pEndDt,pDept,pTeam,pUserId,Radio_Result,ChkRes));
		} catch (IOException e) {
	...
	*/ 
	private String reqCncl(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmr3300.reqCncl(AcptNo,UserId,conMsg,ConfUsr));
		} catch (IOException e) {
		    return ParsingCommon.toJson("ERROR"+e.getMessage());
		} catch (Exception e) {
			return ParsingCommon.toJson("ERROR"+e.getMessage());
	...
	*/ 
	private String cnclYn(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    String AcptNo = ParsingCommon.jsonStrToStr(ParsingCommon.jsonEtoStr(jsonElement, "AcptNo"));
		    return ParsingCommon.toJson(cmr3300.cnclYn(AcptNo));
		} catch (IOException e) {
		    return ParsingCommon.toJson("ERROR"+e.getMessage());
		} catch (Exception e) {
			return ParsingCommon.toJson("ERROR"+e.getMessage());
	...
	*/ 
	private String reqDelete(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    String ConfUsr = ParsingCommon.jsonStrToStr(ParsingCommon.jsonEtoStr(jsonElement, "ConfUsr"));
		    return ParsingCommon.toJson(cmr3300.reqDelete(AcptNo,UserId,QryCd,ConfUsr));
		} catch (IOException e) {
		    return ParsingCommon.toJson("ERROR"+e.getMessage());
		} catch (Exception e) {
			return ParsingCommon.toJson("ERROR"+e.getMessage());
