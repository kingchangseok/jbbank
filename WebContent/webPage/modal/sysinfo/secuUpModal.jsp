...
<body style="width: 100% !important; min-width: 0px !important">
	<div class="pop-header">
		<div>
			<label id="lblTitle">[취약점대상확장자 편집]</label>
		</div>
		<div>
	...
	<div class="container-fluid pop_wrap">
		...
		<div class="row">					
			<div class="width-50 dib vat"> 
	            <label class="title">취약점대상확장자 [ex : .jsp]</label>
			</div>
		</div>
...
<script type="text/javascript" src="<c:url value="/js/ecams/modal/sysinfo/secuUpModal.js"/>"></script>