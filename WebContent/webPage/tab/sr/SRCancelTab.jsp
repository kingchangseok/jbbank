...
<body style="padding: 10px !important; width: 100% !important; min-width: 0px !important;">
	...
	<div class="l_wrap width-100 vat write_wrap"><!--ver2-->
		<div class="row">
			<dl>
				...
				<dd>
					...
					<label id="lblComment" style="color: red;"></label>
				</dd>
			</dl>
		</div>
		<div class="row">
		...
		<div class="row float-right">
			<button id="cmdReq" class="btn_basic_s" disabled=true>SR취소</button>
		</div>
	</div>
</body>
...
<script type="text/javascript" src="<c:url value="/js/ecams/tab/sr/SRCancelTab.js"/>"></script>