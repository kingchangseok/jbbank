	...
	<div class="half_wrap" style="height: 67%">
		...
		<div class="tab_wrap">
			<ul class="tabs">
				...
				<li rel="tabMonitoring" id="tab6">모니터링체크</li>
				<li rel="tabSRComplete" id="tab7" class="on">SR완료</li>
			</ul>
		</div>
		<!-- tab E-->
...
<script type="text/javascript" src="<c:url value="/js/ecams/sr/SRComplete.js"/>"></script>