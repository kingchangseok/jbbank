            ...
            <div class="dib vat width-40">
                ...
                <div class="row write_wrap">
                    <div class="vat width-100">
                        ...
                        <div class="ml_100">
                            <textarea id="txtEXPRSC" name="txtEXPRSC" style="align-content:flex-start; width:100%; height:78px; resize: none; overflow-y:auto;"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" style="margin-left: 10px;">
                    ...
                    <div class="row">
                        <div class="vat width-100 write_wrap">
                            <textarea id="txtConf" name="txtConf" style="align-content:flex-start; width:100%; height:66px; resize: none; overflow-y:auto;"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="vat width-100">
...
<script type="text/javascript" src="<c:url value="/js/ecams/tab/rfc/RFCRegisterTab.js"/>"></script>
