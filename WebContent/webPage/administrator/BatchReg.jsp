		...
		<div class="az_in_wrap">
			<div class="sm-row vat">
				...
				<div class="dib tar" style="width:calc(50% - 135px);">
					...
					<div class="ml_90 tal">
						<div id="cboSvrCd" data-ax5select="cboSvrCd" data-ax5select-config="{size:'sm',theme:'primary',selecteditable: true}"></div>
					</div>
				</div>
