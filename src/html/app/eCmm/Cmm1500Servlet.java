...
@WebServlet("/webPage/ecmm/Cmm1500Servlet")
public class Cmm1500Servlet extends HttpServlet {
	...
	*/ 
	private String getAgentState(JsonElement jsonElement) throws SQLException, Exception {
		...
		try {
		    ...
		    return ParsingCommon.toJson(cmm1500.getAgentState(sysCD,sType));
		} catch (IOException e) {
